...
export const sendRegistrationConfirmationEmail = async (registration: RegistrationData): Promise<void> => {
  try {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>You can also print your registration tag by visiting our website:</p>
